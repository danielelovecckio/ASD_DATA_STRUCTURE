...
template< class T, class P > //definiamo due segnaposto, perchè la variabile di tipo posizione può essere un intero o un puntatore (t per tipoelem) (p per iteratore)
class Linear_list{
 public:
